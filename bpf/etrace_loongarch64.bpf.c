...
// ===========================================================================
// Syscall entry/exit — loongarch64: tp_btf/sys_enter + sys_exit tracepoints.
// Tracepoint context provides regs/id (enter) and regs/ret (exit) directly;
// only the futex wait-flag needs a raw pt_regs member (regs[5] = a1).
// ===========================================================================
...
#define ETD_SYSCALL_ARG1(regs) BPF_CORE_READ(regs, regs[5])  // a1 = 2nd syscall arg
