// arm64 build. Shared programs live in etrace_common.h.
#include "etrace_common.h"

// ===========================================================================
// Syscall entry/exit — arm64: tp_btf/sys_enter + sys_exit tracepoints.
// The tracepoint context provides regs/id and regs/ret directly; only the
// futex wait-flag needs a raw pt_regs member (regs[1] = 2nd syscall arg).
// ===========================================================================
#define ETD_NR_FUTEX 98  // arm64
#define FUTEX_WAIT 0
